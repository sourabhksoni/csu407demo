...
def test_raw_audio_routes_to_whisper_transcription_with_low_confidence():
    d = Router().classify("kcc_call_recording.mp3")
    assert d.modality is Modality.VOICE_AUDIO
    assert d.tool == "tools.audio_transcribe"
